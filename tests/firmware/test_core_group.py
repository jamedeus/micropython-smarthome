...
class MockDevice(Device):
    def __init__(self, name, nickname, _type, default_rule, schedule):
        super().__init__(name, nickname, _type, default_rule, schedule)
...
class MockSensor(Sensor):
    def __init__(self, name, nickname, _type, default_rule, schedule, targets):
        super().__init__(name, nickname, _type, default_rule, schedule, targets)
...
class TestGroup(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.device = MockDevice('device1', 'device1', 'device', 'enabled', {})
        cls.sensor = MockSensor('sensor1', 'sensor1', 'sensor', 'enabled', {}, [cls.device])
