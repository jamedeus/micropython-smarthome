# Modified version of pfalcon's logging library: https://github.com/pfalcon/pycopy-lib/blob/master/logging/logging/__init__.py
#
# Changes:
#   - FileHandler.formatTime() prepends leading 0s to single-digit month/day/hour/min/sec
#   - Use time instead of utime
...
class Formatter:
    ...
    def formatTime(self, record, datefmt=None):
        ...
        ct = list(time.localtime(record.created))
