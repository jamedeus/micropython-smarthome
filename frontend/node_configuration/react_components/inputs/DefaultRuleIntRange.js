...
function DefaultRuleIntRange({ id, value, min, max, metadata, onChange }) {
    return (
        <>
            <InputWrapper label="Default Rule">
                <div className="d-flex flex-row align-items-center my-2">
                    ...
                    <input type="range" className="mx-auto" min={metadata.rule_limits[0]} max={metadata.rule_limits[1]} data-displaymin="1" data-displaymax="100" data-displaytype="int" step="1" value={value} onChange={(e) => onChange(id, e.target.value)} autoComplete="off" />
