...
test_config_2 = {"metadata": {"id": "Test2", "location": "Bedroom", "floor": "2"}, "wifi": {"ssid": "jamnet", "password": "cjZY8PTa4ZQ6S83A"}, "device1": {"nickname": "Air Conditioner", "type": "api-target", "ip": "127.0.0.1", "default_rule": {"on": ["ir_key", "ac", "start"], "off": ["ir_key", "ac", "stop"]}, "schedule": {"10:00": {"on": ["ir_key", "ac", "start"], "off": ["ir_key", "ac", "stop"]}, "00:00": {"on": ["ir_key", "ac", "stop"], "off": ["ir_key", "ac", "stop"]}}}, "sensor1": {"type": "si7021", "nickname": "Thermostat", "mode": "cool", "tolerance": "0.5", "default_rule": 74, "targets": ["device1"], "schedule": {}}, "ir_blaster": {"nickname": "", "pin": "19", "target": ["ac"]}}
