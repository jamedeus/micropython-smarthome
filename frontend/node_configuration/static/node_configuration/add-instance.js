...
async function load_sensor_section(select) {
    ...
    var template = `<div class="mb-2">
                        ...
                        <input type="text" class="form-control sensor${index}" id="sensor${index}-nickname" placeholder="" onchange="update_nickname(this)" required>
                    </div>`
...
async function load_device_section(select) {
    ...
    var template = `<div class="mb-2">
                        ...
                        <input type="text" class="form-control device${index}" id="device${index}-nickname" placeholder="" onchange="update_nickname(this)" required>
                    </div>`
