...
cp desktop-integration.py /home/$USER/.local/bin/desktop-integration.py || { printf "Failed to install application.\n"; exit 1; }
...
ExecStart=/home/$USER/.local/bin/gunicorn --workers 2 --timeout 60 --bind 0.0.0.0:5000 desktop-integration:app
